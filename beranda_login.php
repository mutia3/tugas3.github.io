...
<head>
    ...
    <title>Halaman Beranda Login</title>
...
<form class="col-md-3 mx-auto">
    <div class="text-center mx-auto">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="120px" height="120px" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0m0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5z" clip-rule="evenodd"/></svg>    </div><br>
    <div class="mb-3 text-center">
        <button type="button" class="btn btn-primary col-10 mx-auto">
            <a href="login.php" class="text-white"><b>Masuk</b></a>
        </button>
    </div>
    <div class="mb-3 text-center">
        <button type="button" class="btn btn-primary col-10 mx-auto">
            <a href="register.php" class="text-white"><b>Daftar</b></a>
        </button>
    </div>
