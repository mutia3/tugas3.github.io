<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-ulasan" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="date" class="form-control" placeholder="Tanggal" name="tanggal" aria-describedby="sizing-addon2" value="<?php echo $dataUlasan->tanggal; ?>">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
      </span>
      <input type="time" step="1" class="form-control" placeholder="Jam" name="jam" aria-describedby="sizing-addon2" value="<?php echo $dataUlasan->jam; ?>">
    </div>
