<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-transaksi" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="date" class="form-control" placeholder="Tanggal Transaksi" name="tanggal_transaksi" aria-describedby="sizing-addon2" value="<?php echo $dataTransaksi->tanggal_transaksi; ?>">
    </div>
	<div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
